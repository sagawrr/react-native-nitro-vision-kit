...
/**
 * Represents the JavaScript object/struct "VisionRect".
 */
@DoNotStrip
@Keep
data class VisionRect(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is VisionRect) return false
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(x: Double, y: Double, width: Double, height: Double): VisionRect {
