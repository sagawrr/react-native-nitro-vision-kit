...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrovisionkit::Rect> final {
    static inline margelo::nitro::nitrovisionkit::Rect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrovisionkit::Rect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrovisionkit::Rect& arg) {
