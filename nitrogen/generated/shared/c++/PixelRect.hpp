...
namespace margelo::nitro::nitrovisionkit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PixelRect).
   */
  ...
  public:
    PixelRect() = default;
    explicit PixelRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const PixelRect& lhs, const PixelRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ PixelRect <> JS PixelRect (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrovisionkit::PixelRect> final {
    static inline margelo::nitro::nitrovisionkit::PixelRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrovisionkit::PixelRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrovisionkit::PixelRect& arg) {
