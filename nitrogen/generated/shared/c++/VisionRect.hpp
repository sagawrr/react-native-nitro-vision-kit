...
namespace margelo::nitro::nitrovisionkit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (VisionRect).
   */
  struct VisionRect final {
  public:
  ...
  public:
    VisionRect() = default;
    explicit VisionRect(double x, double y, double width, double height): x(x), y(y), width(width), height(height) {}

  public:
    friend bool operator==(const VisionRect& lhs, const VisionRect& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ VisionRect <> JS VisionRect (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrovisionkit::VisionRect> final {
    static inline margelo::nitro::nitrovisionkit::VisionRect fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrovisionkit::VisionRect(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrovisionkit::VisionRect& arg) {
