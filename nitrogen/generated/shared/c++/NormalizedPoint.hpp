...
namespace margelo::nitro::nitrovisionkit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NormalizedPoint).
   */
  ...
  public:
    ...
    explicit NormalizedPoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const NormalizedPoint& lhs, const NormalizedPoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NormalizedPoint <> JS NormalizedPoint (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrovisionkit::NormalizedPoint> final {
    static inline margelo::nitro::nitrovisionkit::NormalizedPoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrovisionkit::NormalizedPoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrovisionkit::NormalizedPoint& arg) {
